...
has_block definition =>
  (
   render_list => [ qw(description type mode group deauthMethod useCoA cliAccess ExternalPortalEnforcement VoIPEnabled VoIPLLDPDetect VoIPCDPDetect VoIPDHCPDetect VoIPAccountingDetect uplink_dynamic uplink controllerIp controllerPort) ],
  );
