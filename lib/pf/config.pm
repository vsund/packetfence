...
BEGIN {
    ...
    @EXPORT = qw(
        ...
        $WIRELESS_802_1X $WIRELESS_MAC_AUTH $WIRED_802_1X $WIRED_MAC_AUTH $WIRED_SNMP_TRAPS $UNKNOWN $INLINE $ACCOUNTING $ACCOUNTING_WIRED $ACCOUNTING_WIRELESS
...
Readonly our $ACCOUNTING_WIRED    => 0b001001000;
Readonly our $ACCOUNTING_WIRELESS => 0b100001000;
...
Readonly our $ACCOUNTING => 0b000001000;
...
%connection_type = (
    ...
    'Wired-Accounting'      => $ACCOUNTING_WIRED,
    'Wireless-Accounting'   => $ACCOUNTING_WIRELESS,
);
%connection_group = (
    'Wireless'              => $WIRELESS,
    'Ethernet'              => $WIRED,
...
%connection_type_explained = (
    ...
    $UNKNOWN => 'Unknown',
    $ACCOUNTING_WIRED => 'Wired Accounting',
    $ACCOUNTING_WIRELESS => 'Wifi Accounting',
);
